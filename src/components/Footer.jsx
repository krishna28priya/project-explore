...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-purple-800 to-blue-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center mb-4">
              <img src="/src/assets/logo.svg" alt="ProjectExplore Logo" className="h-8 w-8 mr-2" />
            ...
            <p className="text-purple-200 mb-4 max-w-md">
              Empowering students and developers with hands-on learning through real-world projects across various technology domains.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/domains" className="text-purple-200 hover:text-white transition-colors">
                  Domains
                </Link>
              </li>
              <li>
                <Link to="/explore" className="text-purple-200 hover:text-white transition-colors">
                  Explore Projects
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-purple-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-purple-300 text-sm">
            &copy; {new Date().getFullYear()} ProjectExplore. All rights reserved.
          </p>
